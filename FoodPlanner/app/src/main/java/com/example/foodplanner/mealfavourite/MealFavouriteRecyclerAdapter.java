...
public class MealFavouriteRecyclerAdapter extends RecyclerView.Adapter<MealFavouriteRecyclerAdapter.MyViewHolder> {
    private List<MealDTO> meals;
    private OnMealClickListener onMealClickListener;
    private OnRemoveButtonClickListener onRemoveButtonClickListener;

    public MealFavouriteRecyclerAdapter(List<MealDTO> meals) {
        this.meals = meals;
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(MealDTO meal) {
            ...
            addIngredientsBtn.setText("Remove From Favourites");
